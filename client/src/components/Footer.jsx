...
import { FaFacebook, FaTwitter, FaInstagram, FaLinkedin,FaAngleDoubleUp} from 'react-icons/fa';
    ...
    <footer className="bg-blue-100 text-white py-4 px-10">
      ...
      <div className="bg-gray-700 text-center py-4 mt-6 rounded-3xl">
        ...
        <p>
          ...
          >
            <FaAngleDoubleUp className="mr-1" /> Back to Top
          </a>
        </p>
      </div>
    </footer>
